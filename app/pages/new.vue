        ...
        <div class="w-full pb-16 px-16 inline-flex flex-col justify-start items-center gap-12 bg-[url('/page-bg.webp')] bg-top bg-contain bg-no-repeat">
            <header class="sticky top-0 z-10 backdrop-blur-md w-full inline-flex">
                <div class="w-full h-20 max-w-[1366px] inline-flex justify-between items-center mx-auto">
                    ...
                    <div class="flex justify-start items-center gap-6">
                        <button
                            class="px-4 py-2 rounded-lg outline-1 -outline-offset-1 outline-slate-100 flex justify-center items-center gap-2">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="w-full max-w-[1366px] justify-start text-slate-100 text-2xl font-bold ">Our Servers
            </div>
            <div class="w-full max-w-[1366px] grid grid-cols-3 justify-start items-start gap-6">
            ...
            <div class="w-full max-w-[1366px] justify-start text-slate-100 text-2xl font-bold ">Upcoming
                Servers
            </div>
            <div class="w-full max-w-[1366px] grid grid-cols-2 justify-start items-start gap-6">
            ...
            <div class="w-full max-w-[1366px] px-24 py-16 rounded-2xl inline-flex justify-center items-center gap-4 bg-[url(/wiki-bg.webp)] bg-center bg-cover">
            ...
            <div class="self-stretch w-full p-0 m-0 bg-[url(/win-platform-bg.webp)] bg-center bg-cover">
                <div class="self-stretch w-full p-0 m-0 bg-linear-to-r from-[#1F2426] via-[#1F2426]/0 to-[#1F2426]">
                    <div
                        ...
                        <div class="flex flex-col justify-center items-center gap-8">
                            <img class="w-80 h-44" src="/windows-platform.webp" />
                            <div class="text-center justify-start text-white text-3xl font-bold">Get the desktop
                                app</div>
                            <div class="text-center justify-start text-white text-lg">Download Detona
                                launcher aand join our community</div>
                            <div class="px-8 py-3 bg-blue-700 rounded-lg inline-flex justify-center items-center gap-4">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M3.005 12L3 6.408L9.8 5.485V12.002H3.005V12ZM11 5.32L19.997 4V12H11V5.32ZM20.067 13L19.998 21L10.933 19.725L11 13H20.067ZM9.8 19.58L3.005 18.649V13H9.8V19.58Z"
                                        fill="white" />
            ...
            <div class="w-full max-w-[1366px] inline-flex justify-start items-center gap-16">
                <div class="inline-flex flex-col justify-center items-start gap-6">
                    <img class="h-11" src="/logo_new.webp" />
                    <div class="text-center justify-start text-slate-500 text-sm font-normal ">2026 Game
                        Project Detona</div>
                </div>
                <div class="w-[878px] inline-flex flex-col justify-start items-start gap-11">
                    <div class="self-stretch inline-flex justify-start items-center gap-8">
                        <div class="flex justify-start items-center gap-8">
                            ...
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Home page
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">News</div>
                            ...
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Community
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Wiki</div>
                        ...
                        <div class="flex justify-start items-center gap-8">
                            ...
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Detona IL
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Detona C5
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Detona H5
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="inline-flex justify-start items-center gap-8">
                        <div class="flex justify-start items-center gap-8">
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-blue-400 text-sm">Documentation:
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Server Rules
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Privacy
                                    policy</div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Terms and
                                    Conditions</div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Cookie policy
                                </div>
                            </div>
                            <div class="flex justify-start items-center gap-2">
                                <div class="justify-start text-slate-100 text-sm">Refound
                                    policy</div>
                            </div>
                        </div>
                    </div>
