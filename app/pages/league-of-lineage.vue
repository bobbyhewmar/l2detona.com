                ...
                <section class="w-full max-w-[1366px] grid grid-cols-2 lg:grid-cols-3 justify-start items-start gap-6 mb-16">
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            ...
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/adventure.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/adventure-class-name.webp" />
...
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            class="self-stretch h-60 px-8 relative rounded-2xl flex flex-col justify-center items-end gap-4 bg-[url(/interlude-frame.webp)]">
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/cardinal.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/cardinal-class-name.webp" />
                                <div class="px-6 py-3 bg-blue-700 rounded-2xl inline-flex justify-center items-center gap-4">
                                    <div class="justify-start text-slate-100 text-sm flex items-center gap-2">
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            class="self-stretch h-60 px-8 relative rounded-2xl flex flex-col justify-center items-end gap-4 bg-[url(/interlude-frame.webp)]">
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/dreadnought.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/dreadnought-class-name.webp" />
                                <div class="px-6 py-3 bg-blue-700 rounded-2xl inline-flex justify-center items-center gap-4">
                                    <div class="justify-start text-slate-100 text-sm flex items-center gap-2">
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            class="self-stretch h-60 px-8 relative rounded-2xl flex flex-col justify-center items-end gap-4 bg-[url(/interlude-frame.webp)]">
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/phoenix-knight.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/phoenix-knight-class-name.webp" />
                                <div class="px-6 py-3 bg-blue-700 rounded-2xl inline-flex justify-center items-center gap-4">
                                    <div class="justify-start text-slate-100 text-sm flex items-center gap-2">
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            class="self-stretch h-60 px-8 relative rounded-2xl flex flex-col justify-center items-end gap-4 bg-[url(/interlude-frame.webp)]">
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/storm-screamer.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/storm-screamer-class-name.webp" />
                                <div class="px-6 py-3 bg-blue-700 rounded-2xl inline-flex justify-center items-center gap-4">
                                    <div class="justify-start text-slate-100 text-sm flex items-center gap-2">
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="w-full rounded-2xl inline-flex flex-col justify-start items-start">
                        <div
                            class="self-stretch h-60 px-8 relative rounded-2xl flex flex-col justify-center items-end gap-4 bg-[url(/interlude-frame.webp)]">
                            <img class="h-64 left-0 bottom-0 absolute z-1 rounded-bl-2xl" src="/class/titan.webp" />
                            <div class="w-56 flex flex-col justify-start items-end z-2">
                                <img class="w-auto h-24" src="/class/titan-class-name.webp" />
                                <div class="px-6 py-3 bg-blue-700 rounded-2xl inline-flex justify-center items-center gap-4">
                                    <div class="justify-start text-slate-100 text-sm flex items-center gap-2">
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2.75V13.25L12.25 8L2.75 2.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
